...
$route['products/detail/(\d+)'] = 'products/detail/$1';

$route['cart'] = 'cart/index';
$route['checkout'] = 'checkout/index';

$route['orders/track/(.+)'] = 'orders/track/$1';

$route['blog'] = 'blog/index';
$route['blog/(.+)'] = 'blog/detail/$1';

$route['notifications/pull'] = 'notifications/pull';
...
$route['admin/flavors'] = 'admin/flavors/index';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
