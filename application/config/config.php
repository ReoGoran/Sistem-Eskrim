...
|
*/
$config['base_url'] = 'http://localhost/Sistem-Eskrim/';
...
|
*/
$config['enable_hooks'] = FALSE; // can switch to TRUE if using custom hooks later
...
|
*/
$config['encryption_key'] = 'ICEscoopSecretKey_ChangeMe123!';
...
|
*/
$config['global_xss_filtering'] = TRUE; // basic global XSS filtering
...
$config['csrf_token_name'] = 'icescoop_csrf_token';
$config['csrf_cookie_name'] = 'icescoop_csrf_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array('notifications/pull','chat');
